---
title: "The $85k Truck Budget"
summary: "A real, line-item Spokane food-truck startup budget — the kind nobody shows you."
order: 1
---
...
## The headline
A solid Spokane food-truck launch lands around **$85,000** for the build + permits +
launch. Add a working-capital buffer and the all-in number is closer to **~$93k** —
that's the difference between "the truck exists" and "the truck survives month one."

Industry context (IBISWorld / Toast): food-truck startups run **$100k–$250k** at the
high end; a used truck is **$30–60k**, a new custom build **$80–125k**. The $85k path
below uses a quality **mid-build** and disciplined choices.

## The line items

| # | Item | Budget | Notes |
|---|---|---:|---|
| 1 | Truck + kitchen build (mid, used base) | $55,000 | Used base $30–60k + outfitting. New build pushes $80–125k. |
...
| 9 | Launch marketing | $2,000 | First-service push, the channel, the list. |
| 10 | Contingency (the honest line) | $2,500 | Something always costs more. |
| | **Build + launch total** | **~$79,500** | |
| 11 | Working-capital buffer (1–2 mo) | $13,500 | Payroll, fuel, restock, slow days. |
...
SRHD mobile-unit permit + plan-review (509.324.1560) · Spokane Fire permit · a real
commissary monthly rate · an insurance quote · the truck build quote. Every one
becomes a Build Receipt.

*Sourcing + full permit path: the SlicedLabs research hub. © 2026 SlicedLabs.*
